  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children: [
          ...
          IconButton(
            ...
            icon: themeCubit.state.isDarkMode ? Icon(Icons.dark_mode_outlined, size: 100) : Icon( Icons.light_mode_outlined, size: 100 ),
            onPressed: () {
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () => usernameCubit.setUserName(RandomGenerator.getRandomName()),
      ),
    );
  }
}
